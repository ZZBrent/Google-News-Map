...
function addMarker(place)
{
    ...
    var icon = "http://maps.google.com/mapfiles/ms/micons/green-dot.png";
    ...
    $.getJSON(Flask.url_for("articles"), {geo: place.postal_code}, function(articles) {
        ...
        //Check that there are articles before displaying
        if (!$.isEmptyObject(articles))
        {
            var articleList = "<ol>";
            for (var i = 0; i < articles.length; i++)
            {
            	articleList += "<li><a target='_NEW' href='" + articles[i].link
		...
		// add a listener to the marker to check for clicks
